...
@Entity
public class ChandruGuruChildren {
    @Id
    private int babyId;
    ...
    public ChandruGuruChildren() {
    }
    public ChandruGuruChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
