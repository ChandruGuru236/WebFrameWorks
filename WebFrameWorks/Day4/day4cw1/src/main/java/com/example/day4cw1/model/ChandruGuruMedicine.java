...
@Entity
public class ChandruGuruMedicine {
    @Id
    ...
    public ChandruGuruMedicine() {
    }
    public ChandruGuruMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
