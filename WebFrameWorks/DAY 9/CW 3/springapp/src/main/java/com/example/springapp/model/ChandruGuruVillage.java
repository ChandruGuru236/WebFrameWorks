...
@Entity
public class ChandruGuruVillage {
    @Id
    ...
    public ChandruGuruVillage(){}
    public ChandruGuruVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
